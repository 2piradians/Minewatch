...
public class GuiHeroSelect extends GuiScreen implements IGuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		case MAIN:
			...
			this.drawString(mc.fontRenderer, text, 5, 5, 0xFFFFFF);
			GlStateManager.popMatrix();
			...
			mc.fontRenderer.drawString(text, (int) (this.width/scale-mc.fontRenderer.getStringWidth(text)-25), 8, 0xFFFFFF, true);
			GlStateManager.popMatrix();
			...
			this.drawCenteredString(mc.fontRenderer, TextFormatting.AQUA+""+TextFormatting.ITALIC+mc.player.getName().toUpperCase(), (int) (this.width/2), (int) (this.height*0.67f), 0xFFFFFF);
