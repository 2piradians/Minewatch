...
public class GuiTab extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		case MAIN:
			...
			this.drawCenteredString(fontRenderer, mainScreenHero.getFormattedName(false), this.guiLeft + 190, this.guiTop + 180, 0x7F7F7F);
			break;
		case SERVERS:
			try {
		...
		case GALLERY_HERO:
			...
			textScale = 1.9d;
			GlStateManager.scale(textScale, textScale, 1);
			this.fontRenderer.drawString(TextFormatting.ITALIC+galleryHero.getFormattedName(true), (int) ((this.guiLeft+11)/textScale), (int) ((this.guiTop+16)/textScale), 0, false);
			GlStateManager.scale(1.004d, 1.004d, 1);
			GlStateManager.translate(-1.3F, 0, 0);
			this.fontRenderer.drawString(TextFormatting.ITALIC+galleryHero.getFormattedName(true), (int) ((this.guiLeft+11)/textScale), (int) ((this.guiTop+16)/textScale), 0x7F7F7F, false);
			break;
