...
public class Maps {
	...
	public static enum MinecraftMap {
		...
		NECROPOLIS_CAGRIMANOKA(OverwatchMap.NECROPOLIS, "Cagrimanoka_TR", "https://www.planetminecraft.com/project/necropolis-overwatch-worldObj-download/"),
		BLACK_FOREST_CAGRIMANOKA(OverwatchMap.BLACK_FOREST, "Cagrimanoka_TR", "https://www.planetminecraft.com/project/worldObj-save-black-forest-overwatch/"),
	...
	public static enum OverwatchMap {
		...
		ECOPOINT("Ecopoint: Antarctica was an Overwatch-run research facility near the coast of Antarctica. The scientists stationed here - Adams, MacReady, Opara, Torres, Arrhenius, and Mei-Ling Zhou - were investigating climate anomalies and cryostasis technology when a massive storm hit the ecopoint, and they lost connection to the outside worldObj. As their food and energy supplies dwindled, the scientists were forced to freeze themselves in cryostasis until help arrived.\n" + 
