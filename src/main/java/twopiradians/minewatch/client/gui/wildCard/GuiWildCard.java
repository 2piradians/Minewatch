...
public class GuiWildCard extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.fontRenderer.drawString(TextFormatting.ITALIC+"Select a token to receive in exchange", (int) ((this.guiLeft+14)/textScale), (int) ((this.guiTop+18)/textScale), 0, false);
		this.fontRenderer.drawString(TextFormatting.ITALIC+" for the Wild Card Token.", (int) ((this.guiLeft+48)/textScale), (int) ((this.guiTop+30)/textScale), 0, false);
		GlStateManager.translate(-0.7F, -0.2f, 0);
		this.fontRenderer.drawString(TextFormatting.ITALIC+"Select a token to receive in exchange", (int) ((this.guiLeft+14)/textScale), (int) ((this.guiTop+18)/textScale), 0x7F7F7F, false);
		this.fontRenderer.drawString(TextFormatting.ITALIC+" for the Wild Card Token.", (int) ((this.guiLeft+48)/textScale), (int) ((this.guiTop+30)/textScale), 0x7F7F7F, false);
		...
		for (GuiButton button : this.buttonList) 
			if (button.isMouseOver() && button instanceof GuiButtonWildCard) {
				...
				this.drawHoveringText(new ArrayList<String>() {{add(name);}}, 
						button.x-mc.fontRenderer.getStringWidth(name)/2+4, button.y+51);
				break;
			}
