...
public class RenderMercyBeam extends Render<EntityMercyBeam> {
	...
	public void doRender(EntityMercyBeam entity, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		double d4 = entity.player.prevPosX + (entity.player.posX - entity.player.prevPosX) * (double)partialTicks + vec3d.x;
		double d5 = entity.player.prevPosY + (entity.player.posY - entity.player.prevPosY) * (double)partialTicks + vec3d.y+0.1d;
		double d6 = entity.player.prevPosZ + (entity.player.posZ - entity.player.prevPosZ) * (double)partialTicks + vec3d.z;
