...
public class RenderMercyBullet extends Render<EntityMercyBullet> {
	
	private final ModelSoldier76Bullet MERCY_BULLET_MODEL = new ModelSoldier76Bullet();
	
	public RenderMercyBullet(RenderManager renderManager) {
		super(renderManager);
	}

	@Override
	protected ResourceLocation getEntityTexture(EntityMercyBullet entity) {
		return new ResourceLocation(Minewatch.MODID, "textures/entity/ana_bullet.png");
	}
	
	@Override
	public void doRender(EntityMercyBullet entity, double x, double y, double z, float entityYaw, float partialTicks) {
