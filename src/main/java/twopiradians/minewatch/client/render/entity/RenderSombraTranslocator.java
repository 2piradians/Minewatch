...
public class RenderSombraTranslocator extends RenderOBJModel<EntitySombraTranslocator> {
	...
	@Override
	protected boolean preRender(EntitySombraTranslocator entity, int model, VertexBuffer buffer, double x, double y, double z, float entityYaw, float partialTicks) {		
