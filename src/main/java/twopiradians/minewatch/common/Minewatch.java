...
@Mod(modid = Minewatch.MODID, version = Minewatch.VERSION, name = Minewatch.MODNAME, updateJSON = "https://raw.githubusercontent.com/2piradians/Minewatch/1.10.2/update.json")
