...
public class CommandMinewatch implements ICommand {
	...
	private static final ArrayList<String> ALL_HERO_NAMES = new ArrayList<String>();
	static {
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		if (sender instanceof EntityPlayer && args.length == 1) {
			...
			if (hero != null) {
				...
				sender.sendMessage(new TextComponentTranslation(TextFormatting.RED+args[0]+" is not a valid hero"));
		}
	}
