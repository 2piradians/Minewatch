...
public class EntityJunkratGrenade extends EntityMW {
	...
	public void explode(@Nullable Entity directHit) {
		if (this.worldObj.isRemote) {
			...
			if (this.isDeathGrenade)
				this.worldObj.playSound(this.posX, this.posY, this.posZ, ModSoundEvents.junkratGrenadeExplode, 
	...
	protected void onImpact(RayTraceResult result) {	
		...
		else if (!this.worldObj.isRemote && result.entityHit != null && !this.isDeathGrenade) {
