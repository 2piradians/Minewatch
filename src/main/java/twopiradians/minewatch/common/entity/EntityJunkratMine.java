...
public class EntityJunkratMine extends EntityLivingBaseMW {
	...
	public void onUpdate() {	
		...
		if (prevOnGround != onGround && onGround) 
			this.worldObj.playSound(null, this.getPosition(), ModSoundEvents.junkratMineLand, SoundCategory.PLAYERS, 1.0f, 1.0f);
	...
	public void explode() {
		if (this.worldObj.isRemote) {
			...
			this.worldObj.playSound(this.posX, this.posY, this.posZ, ModSoundEvents.junkratMineExplode, 
