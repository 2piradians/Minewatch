	...
	public static final Handler FROZEN = new Handler(Identifier.POTION_FROZEN, false) {
		...
		public boolean onServerTick() {
			...
			if (this.ticksLeft >= 30) {
				...
				entityLiving.worldObj.playSound(null, entityLiving.getPosition(), ModSoundEvents.meiFreeze, SoundCategory.NEUTRAL, 1.0f, 1.0f);
	...
	public void onUpdate() {		
		...
		if (this.worldObj.isRemote) {
			...
			for (int i=0; i<numParticles; ++i)
				Minewatch.proxy.spawnParticlesCustom(Particle.CIRCLE, this.worldObj, 
