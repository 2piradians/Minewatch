...
public class ModEntities {
	...
	public static void registerEntities() {
		...
		EntityRegistry.registerModEntity(new ResourceLocation(Minewatch.MODID, "ana_grenade"), EntityAnaGrenade.class, "ana_grenade", id++, Minewatch.instance, 64, 20, false);
		...
		EntityRegistry.registerModEntity(new ResourceLocation(Minewatch.MODID, "mccree_stun"), EntityMcCreeStun.class, "mccree_stun", id++, Minewatch.instance, 64, 20, false);
		...
		EntityRegistry.registerModEntity(new ResourceLocation(Minewatch.MODID, "soldier76_heal"), EntitySoldier76Heal.class, "soldier76_heal", id++, Minewatch.instance, 64, 20, false);
		...
		EntityRegistry.registerModEntity(new ResourceLocation(Minewatch.MODID, "widowmaker_hook"), EntityWidowmakerHook.class, "widowmaker_hook", id++, Minewatch.instance, 64, 1000, false);
		...
		EntityRegistry.registerModEntity(new ResourceLocation(Minewatch.MODID, "junkrat_grenade"), EntityJunkratGrenade.class, "junkrat_grenade", id++, Minewatch.instance, 64, 20, true);
	...
	public static ItemStack getSpawnEgg(ResourceLocation id) {
		...
		nbt.setString("id", id.toString()); // PORT 1.10.2 add .replace(":", ".")
