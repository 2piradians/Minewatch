...
public class EntityJunkratTrap extends EntityLivingBaseMW {
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(Math.max(1, 100.0D*Config.getDamageScale(null)));
	}
	...
	public void onUpdate() {
		...
		if (!this.world.isRemote && this.trappedEntity == null && 
			...
			List<Entity> entities = this.world.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox().grow(0.5d));
