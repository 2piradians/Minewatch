...
public class EntityHanzo extends EntityHero {
	...
	protected void initEntityAI() {
		super.initEntityAI();
		this.tasks.addTask(2, new EntityHeroAIAttackHanzoBow(this, 1, 20, 15));
	}

	public class EntityHeroAIAttackHanzoBow extends EntityAIBase {
		...
		public EntityHeroAIAttackHanzoBow(EntityHero entity, double speedAmplifier, int delay, float maxDistance) {
			this.entity = entity;
