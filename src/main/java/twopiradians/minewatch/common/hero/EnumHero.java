...
public enum EnumHero {
	...
	public static void displayPortrait(EnumHero hero, double x, double y, boolean useAlpha, boolean oldPortrait) {
		...
		Rank rank = RankManager.getHighestRank(mc.thePlayer);
		...
		if (useAlpha) {
			...
			GuiUtils.drawTexturedModalRect(-7, -20, 0, (int) (-mc.thePlayer.ticksExisted*0.5d), 240, 230, 0);

			GlStateManager.color(1f, 1f, 1, 0.5f);
			mc.getTextureManager().bindTexture(PORTRAIT_OVERLAY_0);
			GuiUtils.drawTexturedModalRect(-7, -20, 0, -mc.thePlayer.ticksExisted*3, 240, 230, 0);
