				...
				if (hero != null && KeyBind.HERO_INFORMATION.isKeyDown(player))
					...
					if (weapon != null) {
						...
						if (hero != null && weapon.hero == hero && ItemMWArmor.SetManager.getWornSet(player) != null) {
							...
							// keybinds 
							int width1 = Minecraft.getMinecraft().fontRenderer.getStringWidth(hero.ability1.keybind.getKeyName());
							int width2 = Minecraft.getMinecraft().fontRenderer.getStringWidth(hero.ability2.keybind.getKeyName());
