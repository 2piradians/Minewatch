...
import twopiradians.minewatch.common.entity.hero.EntityPharah;
...
public enum EnumHero {
	...
	ANA("Ana", Type.SUPPORT, true, true, 
			200, 0, 0, 1650,
			...
			new Skin(Skin.Type.RARE, "Garnet", "Ana Garnet", "MeoWero", "http://www.minecraftskins.com/skin/12084252/ana-garnet/"),
			new Skin(Skin.Type.RARE, "Peridot", "Ana Peridot", "MeoWero", "http://www.minecraftskins.com/skin/12084288/ana-peridot/"),
			new Skin(Skin.Type.RARE, "Citrine", "Ana Citrine", "MeoWero", "http://www.minecraftskins.com/skin/12084278/ana-citrine/"),
			new Skin(Skin.Type.RARE, "Turquoise", "Ana Turquoise", "MeoWero", "http://www.minecraftskins.com/skin/12084292/ana-turquoise/")), 
	GENJI("Genji", Type.OFFENSE, false, false,  
			200, 0, 0, 1500,
			new Ability(KeyBind.ULTIMATE, false, false),
	...
	HANZO("Hanzo", Type.DEFENSE, false, false,  
			200, 0, 0, 1500,
			new Ability(KeyBind.ULTIMATE, false, false),
			new Ability(KeyBind.ABILITY_2, true, true), 
	...
	MCCREE("McCree", Type.OFFENSE, false, false,  
			200, 0, 0, 1500,
			new Ability(KeyBind.ULTIMATE, false, false),
			new Ability(KeyBind.ABILITY_2, true, false), 
			new Ability(KeyBind.ABILITY_1, true, false), 
			...
			new Skin(Skin.Type.LEGENDARY, "Gambler", "Gambler McCree | Western Skin Contest | Overwatch", "Cayde - 6", "https://www.planetminecraft.com/skin/gambler-mccree-western-skin-contest-overwatch/"),
			new Skin(Skin.Type.LEGENDARY, "Van Helsing", "Overwatch Van Helsing Mccree", "Hiccup415", "https://www.planetminecraft.com/skin/overwatch-van-helsing-mccree/"),
			new Skin(Skin.Type.LEGENDARY, "Mystery Man", "[SKFP]-[#25]-[Mystery Man McCree] | by Notizblatt", "Notizblatt", "https://www.planetminecraft.com/skin/skfp-25-mystery-man-mccree-by-notizblatt/")),
	...
	SOLDIER76("Soldier76", Type.OFFENSE, false, false,  
			200, 0, 0, 2075,
			new Ability(KeyBind.ULTIMATE, false, false),
	...
	TRACER("Tracer", Type.OFFENSE, false, false,  
			...
			new Skin(Skin.Type.EPIC, "Seoul Dynasty", "Tracer [Seoul Dynasty]", "MeoWero", "https://www.planetminecraft.com/skin/tracer-seoul-dynasty/")),
	BASTION("Bastion", Type.DEFENSE, true, false,  
			200, 100, 0, 2075,
			new Ability(KeyBind.ULTIMATE, false, false),
			new Ability(KeyBind.RMB, true, false), 
			new Ability(KeyBind.ABILITY_1, true, false), 
	...
	MEI("Mei", Type.DEFENSE, false, false,  
			250, 0, 0, 1450,
			new Ability(KeyBind.ULTIMATE, false, false),
	...
	WIDOWMAKER("Widowmaker", Type.DEFENSE, false, false,  
			200, 0, 0, 1375,
			new Ability(KeyBind.ULTIMATE, true, false),
			new Ability(KeyBind.ABILITY_2, true, false), 
			new Ability(KeyBind.ABILITY_1, true, false), 
			new Ability(KeyBind.NONE, false, false), 
			30, 0, new ItemWidowmakerRifle(), Crosshair.CIRCLE_SMALL, 0x9A68A3, true, EntityWidowmaker.class, 
			...
			new Skin(Skin.Type.LEGENDARY, "Kerrigan", "Widowmaker [Kerrigan]", "MeoWero", "https://www.planetminecraft.com/skin/widowmaker-kerrigan/")),
	MERCY("Mercy", Type.SUPPORT, true, true,  
			200, 0, 0, 1950,
			new Ability(KeyBind.ULTIMATE, false, false),
			new Ability(KeyBind.NONE, false, false), 
			new Ability(KeyBind.ABILITY_2, false, false), 
			...
			new Skin(Skin.Type.EPIC, "Houston Outlaws", "Mercy [Houston Outlaws]", "MeoWero", "https://www.planetminecraft.com/skin/mercy-houston-outlaws/")),
	JUNKRAT("Junkrat", Type.DEFENSE, false, false,  
			200, 0, 0, 1575,
			new Ability(KeyBind.ULTIMATE, false, false),
			new Ability(KeyBind.ABILITY_2, true, false), 
	...
	LUCIO("Lucio", Type.SUPPORT, true, false,  
			...
			new Skin(Skin.Type.COMMON, "Classic" , "Lucio", "Drazile", "https://www.planetminecraft.com/skin/jet-set-tiesto/"),
			...
			new Skin(Skin.Type.LEGENDARY, "HippityHop", "Overwatch - Lucio", "Drzzter", "https://www.planetminecraft.com/skin/overwatch---lcio-3766449/"),
	...
	ZENYATTA("Zenyatta", Type.SUPPORT, false, false,  
			50, 0, 150, 2075,
			new Ability(KeyBind.ULTIMATE, false, false),
			new Ability(KeyBind.ABILITY_2, true, false), 
			new Ability(KeyBind.ABILITY_1, true, false), 
	...
	MOIRA("Moira", Type.SUPPORT, false, false,  
			200, 0, 0, 2125,
			new Ability(KeyBind.ULTIMATE, false, false),
	...
	DOOMFIST("Doomfist", Type.OFFENSE, false, false,  
			250, 0, 0, 1500,
			new Ability(KeyBind.ULTIMATE, false, false),
			new Ability(KeyBind.RMB, true, false), 
			new Ability(KeyBind.ABILITY_2, true, false), 
	...
	ROADHOG("Roadhog", Type.TANK, false, false,  
			...
			new Skin(Skin.Type.LEGENDARY, "Islander", "Roadhog Islander", "SpookiOrange", "https://www.planetminecraft.com/skin/roadhog-islander/"),
	...
	public int ultimateChargeRequired;
	...
	private EnumHero(String name, Type type, boolean hasAltWeapon, boolean switchAltWithScroll, 
			int baseHealth, int baseArmor, int baseShield, 
			int ultimateChargeRequired,
			Ability ultimate, Ability ability1, Ability ability2, Ability ability3,
