		...
		public boolean onClientTick() {
			if (this.ticksLeft < this.initialTicks - 10 && this.ticksLeft > 10) {
				...
				if (this.ticksLeft % 3 == 0 && entity == Minecraft.getMinecraft().thePlayer && player != null &&
					...
					Vec3d eyes = ItemMWWeapon.getPositionEyes(player, Minecraft.getMinecraft().getRenderPartialTicks()).add(player.getLookVec());
					Minewatch.proxy.spawnParticlesCustom(Particle.SLEEP, player.worldObj, 
				...
				if (this.ticksLeft % 7 == 0) 
					Minewatch.proxy.spawnParticlesCustom(Particle.SLEEP, entity.worldObj, 
				...
				Minewatch.proxy.spawnParticlesCustom(Particle.CIRCLE, entity.worldObj, 
