	...
	public ItemHanzoBow() {
		...
		this.addPropertyOverride(new ResourceLocation("pulling"), new IItemPropertyGetter() {
			...
			/*	if (!(entityIn != null && entityIn.isHandActive() && entityIn.getActiveItemStack() == stack)) {
					System.out.println("world: "+(worldIn == null ? "worldIn = null" : String.valueOf(worldIn.isRemote)));
					System.out.println((worldIn == null ? "worldIn = null" : String.valueOf(worldIn.isRemote))+", "+entityIn == null ? "entityIn = null" : entityIn.getActiveItemStack().getItemDamage()+", "+stack.getItemDamage());
				}*/
					//				return entityIn != null && entityIn.isHandActive() && entityIn.getActiveItemStack().isItemEqualIgnoreDurability(stack) ? 1.0F : 0.0F;
