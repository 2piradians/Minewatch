	...
	public static final Handler ROLL = new Handler(Identifier.MCCREE_ROLL, true) {
		...
		public boolean onClientTick() {
			...
			if (this.ticksLeft % 3 == 0 && this.ticksLeft > 2)
				Minewatch.proxy.spawnParticlesCustom(EnumParticle.SMOKE, player.worldObj, 
						...
						0, 0, 0, 0xB4907B, 0xE6C4AC, 0.7f, 10, 15+player.worldObj.rand.nextInt(5), 15+player.worldObj.rand.nextInt(5), 0, 0);
