...
public class RenderHelper {
	...
	public static void drawHoveringText(@Nullable ItemStack stack, List<String> textLines, int x, int y, double scaleX, double scaleY, int maxTextWidth) {
		...
		RenderTooltipEvent.Pre event = new RenderTooltipEvent.Pre(stack, textLines, x, y, resolution.getScaledWidth(), resolution.getScaledHeight(), maxTextWidth, mc.fontRendererObj);
        ...
        MinecraftForge.EVENT_BUS.post(new RenderTooltipEvent.PostBackground(stack, textLines, tooltipX, tooltipY, mc.fontRendererObj, tooltipTextWidth, tooltipHeight));
        int tooltipTop = tooltipY;
        
        for (int lineNumber = 0; lineNumber < textLines.size(); ++lineNumber)
        {
            String line = textLines.get(lineNumber);
            mc.fontRendererObj.drawStringWithShadow(line, (float)tooltipX, (float)tooltipY, -1);
        ...
        MinecraftForge.EVENT_BUS.post(new RenderTooltipEvent.PostText(stack, textLines, tooltipX, tooltipTop, mc.fontRendererObj, tooltipTextWidth, tooltipHeight));
