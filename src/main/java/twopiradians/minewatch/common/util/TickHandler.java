...
public class TickHandler {
	...
	public static List<Handler> getUnmodifiableHandlers(boolean isRemote) {
		CopyOnWriteArrayList<Handler> handlers = isRemote ? clientHandlers : serverHandlers;
		return Collections.unmodifiableList(handlers);
	}
	
	public static String getHandlersString(boolean isRemote) {
		List<Handler> handlers = getUnmodifiableHandlers(isRemote);
		String ret = "";
		for (Handler handler : handlers) {
			ret += "\n  "+TextFormatting.GREEN+handler.toString();
		}
		return ret;
	}
