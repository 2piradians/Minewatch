...
public class TickHandler {
	...
	public static ArrayList<Handler> getHandlers(Entity entity, @Nullable Identifier identifier) {
		return entity == null ? new ArrayList<Handler>() : getHandlers(entity.worldObj.isRemote, entity, identifier, null);
	}
	...
	public static ArrayList<Handler> getHandlers(Entity entity, Predicate<Handler> predicate) {
		return entity == null ? new ArrayList<Handler>() : getHandlers(entity.worldObj.isRemote, entity, null, predicate);
	}
